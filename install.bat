REM Installs Essential's IntelliJ configs into your user configs.
@echo off
echo Installing Essential IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Essential'.
exit /b
